...
from django_select2.forms import Select2Widget, Select2MultipleWidget, ModelSelect2MultipleWidget, ModelSelect2Widget
...
class CourseForm(forms.ModelForm):
    ...
    class Meta:
        model = Course
        fields = ['course_code', 'name', 'materials', 'teachers', 'updated_associations', 'updated_teacher', 'calendar_year', 'coordinator']
        widgets = {
            'materials': Select2MultipleAddAnother(reverse_lazy('boecie:teachers_overview')),#     TODO: Make this work on the new MSP selection instead of this old one (therefore, up until then keep it like this)
...
class TeacherForm(forms.ModelForm):
    ...
    class Meta:
        model = Teacher
        fields = ['titles', 'initials', 'first_name', 'surname_prefix', 'last_name', 'email', 'active', 'retired', 'user']